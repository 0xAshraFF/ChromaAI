...
chroma-ai embeds an invisible ownership signal into video frames using content-adaptive DCT coefficient modification. The signal survives H.265 compression, JPEG thumbnailing, and resizing without training a neural network.
...
|---|---|---|
| **chroma-ai v1** | **95.9% (CRF28)** | This repo |
...
> HiDDeN/MBRS require GPU training. chroma-ai is CPU-only, zero training.
...
chroma-ai modifies the DCT coefficient at position (0,2) in 8×8 luma blocks — a low-frequency position that survives most compression quantisation tables.
...
chroma-ai addresses Article 50 of the EU AI Act (effective August 2026): machine-readable marking of AI-generated content. See [docs/eu-act.md](docs/eu-act.md).
